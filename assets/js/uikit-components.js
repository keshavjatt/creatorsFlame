    ...
    r = (() => {
      ...
      return s({
        ...
        update: {
          read({ minHeight: t }) {
            if (
              ((this.inactive = !this.matchMedia || !m(this.$el)),
              this.inactive)
            )
            ...
            if (this.expand)
              ...
              !0 === this.offsetBottom
                ...
                ? (e += ` - ${f(this.offsetBottom)}px`)
                : u(this.offsetBottom) &&
                  (e += ` - ${a(g(this.offsetBottom, this.$el)).height}px`),
                (e += (i ? ` - ${i}px` : "") + ")");
            }
          ...
          write({ minHeight: t, prev: e }) {
            r(this.$el, { minHeight: t }),
              ...
              this.minHeight &&
                f(r(this.$el, "minHeight")) < this.minHeight &&
    ...
    return {
      connected() {
        const e = this.$el,
          ...
          r = (this.buttonDown = t(
            `<button class="input-number-down input-number-btn btn">${h}</button>`
          )),
          a = (this.buttonUp = t(
            `<button class="input-number-up input-number-btn btn">${o}</button>`
          ));
        i(e, r), s(e, a);
        const l = (t, e) => {
      ...
      return {
        ...
        connected() {
          h(this.$el, this.clsDrop),
            this.toggle &&
              !this.target &&
              (this.target = this.$create("toggle", U(this.toggle, this.$el), {
                target: this.$el,
                mode: this.mode,
              }));
        },
